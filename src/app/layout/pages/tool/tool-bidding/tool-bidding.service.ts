...
import {SummaryDataValuesInterface} from "@layout/pages/tool/tool-bidding/interfaces/summary_data-values-interface";
import {summaryDataCols} from "@layout/pages/tool/tool-bidding/table/summary-data-cols";
import {TableNewsValuesInterface} from "@layout/pages/tool/tool-bidding/interfaces/table-news-values-interface";
